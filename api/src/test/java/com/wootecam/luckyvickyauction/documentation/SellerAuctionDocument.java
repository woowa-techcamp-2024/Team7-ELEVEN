...
import com.wootecam.luckyvickyauction.dto.CreateAuctionRequest;
                            ...
                            MockMvcRestDocumentation.document("sellerAuctions/createConstantPolicy/success",
                                    ...
                                    PayloadDocumentation.requestFields(
                                            ...
                                            PayloadDocumentation.fieldWithPath("maximumPurchaseLimitCount")
                                                    .description("최대 구매 제한 수량"),
                                            PayloadDocumentation.fieldWithPath("pricePolicy").description("가격 정책"),
                                            PayloadDocumentation.fieldWithPath("pricePolicy.type")
                                                    .description("가격 정책 타입"),
                                            PayloadDocumentation.fieldWithPath("pricePolicy.variationWidth")
                                                    .description(
                                                            "절대 가격 정책시 가격 절대 변동폭"),
                                            PayloadDocumentation.fieldWithPath("variationDuration")
                                                    .description("경매 기간"),
            ...
            mockMvc.perform(RestDocumentationRequestBuilders.delete("/auctions/{auctionId}", auctionId)
                    ...
                    MockMvcRestDocumentation.document("sellerAuctions/delete/success",
                            ...
                            RequestDocumentation.pathParameters(
                                    RequestDocumentation.parameterWithName("auctionId").description("취소할 경매 ID"))
                    )
            ).andExpect(status().isOk());
        }
    }
                    ...
                    .andDo(
                            MockMvcRestDocumentation.document("sellerAuctions/findOneConstantPolicy/success",
                                    ...
                                    PayloadDocumentation.responseFields(
                                            ...
                                            PayloadDocumentation.fieldWithPath("originPrice").type(JsonFieldType.NUMBER)
                                                    .description("상품 원가"),
                                            PayloadDocumentation.fieldWithPath("currentPrice")
                                                    .type(JsonFieldType.NUMBER)
                                                    .description("현재 가격"),
                                            PayloadDocumentation.fieldWithPath("originStock").type(JsonFieldType.NUMBER)
                                                    .description("원래 재고"),
                                            PayloadDocumentation.fieldWithPath("currentStock")
                                                    .type(JsonFieldType.NUMBER)
                                                    .description("현재 재고"),
                                            PayloadDocumentation.fieldWithPath("maximumPurchaseLimitCount")
                                                    .type(JsonFieldType.NUMBER)
                                            ...
                                            PayloadDocumentation.fieldWithPath("finishedAt").type(JsonFieldType.STRING)
                                                    .description("경매 종료 시간"),
                                            PayloadDocumentation.fieldWithPath("isShowStock")
